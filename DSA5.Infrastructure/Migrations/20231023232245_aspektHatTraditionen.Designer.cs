...
namespace DSA5.Infrastructure.Migrations
{
    ...
    [Migration("20231023232245_aspektHatTraditionen")]
    partial class aspektHatTraditionen
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DSA5.Entities.Meta.Korrelationen.AspektGehoertZuTradition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AspektGehoertZuTradition");
                });
            ...
            modelBuilder.Entity("DSA5.Entities.Welt.Tradition", b =>
                {
                    ...
                    b.Property<string>("TraditionArt")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasDiscriminator<string>("TraditionArt").HasValue("Tradition");
            ...
            modelBuilder.Entity("DSA5.Entities.Welt.Geweihtentradition", b =>
                {
                    b.HasBaseType("DSA5.Entities.Welt.Tradition");

                    b.ToTable("Tradition");

                    b.HasDiscriminator().HasValue("Geweiht");
                });

            modelBuilder.Entity("DSA5.Entities.Welt.Zaubertradition", b =>
                {
                    b.HasBaseType("DSA5.Entities.Welt.Tradition");
            ...
            modelBuilder.Entity("DSA5.Entities.Meta.Korrelationen.AspektGehoertZuTradition", b =>
                {
                    b.HasOne("DSA5.Entities.Welt.Aspekt", null)
                        .WithMany("Traditionen")
                        .HasForeignKey("AspektId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DSA5.Entities.Welt.Tradition", "Tradition")
                        .WithMany()
